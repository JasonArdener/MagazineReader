		...
		if (_this.inGesture) {
			...
			if (delta >= _this.GESTURE_DELTA) {
				...
				switch(_this._fingers) {
					...
					case 4:
						switch(direction) {
							case 0: handler = _this.onfourwiperight; break;
							case 1: handler = _this.onfourswipeleft; break;
							case 2: handler = _this.onfourswipedown; break;
							case 3: handler = _this.onfourswipeup; break;
						} break;
					default: break;
				}
